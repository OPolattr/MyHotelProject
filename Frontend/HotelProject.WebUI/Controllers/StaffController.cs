...
namespace HotelProject.WebUI.Controllers
{
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMesseage = await client.GetAsync("http://localhost:5048/api/Staff");
        ...
        public async Task<IActionResult> AddStaff(AddStaffViewModel addStaffViewModel)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:5048/api/Staff", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:5048/api/Staff/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:5048/api/Staff/{id}");
        ...
        public async Task<IActionResult> UpdateStaff(UpdateStaffViewModel updateStaffViewModel)
        {
            ...
            StringContent stringContent = new StringContent(jsonData,Encoding.UTF8,"application/json");
            var responseMessage = await client.PutAsync("http://localhost:5048/api/Staff/",stringContent);
